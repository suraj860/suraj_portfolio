        ...
        <div className="col-lg-6">
          <div className="aboutDiv">
            ...
            <p className="about about2"> Hello! My name is Suraj and I enjoy creating things that live on the internet 
              and also love to solve the complex problems .I completed my <span className="imp">B.E </span> in <span className="imp">Mechanical Eng.</span> My
              interest in web development started when i decided to switch my career to Developer, and
              started learning more about the web , and finally decided to start my journey as a Full-stack
