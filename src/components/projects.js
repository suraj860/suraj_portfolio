    ...
    <div className="container"
     data-aos="zoom-in">
      <div className="row secondDiv">
        ...
        <div className="col-lg-6" style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <a href="https://github.com/suraj860/FILA_Ecommerce_App" target="blank" className="anchor">
          ...
          <a href = "https://fila-ecommerce-website.netlify.app/" target="blank" className="anchor">
            <button className="codeBtn">Live Demo <i className="fas fa-level-up-alt" style={{marginLeft:"8px"}}></i></button>
          </a>
      ...
      <div className="row secondDiv">
        ...
        <div className="col-lg-6" style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <div style={{display:"flex" , marginTop:'15px' , flexWrap:"wrap" , position:"relative"}}>
            ...
            <a href="https://github.com/suraj860/Bike_Rental_Portal_App" target="blank" className="anchor">
            <button className="codeBtn">Source Code <i className="fab fa-github" style={{marginLeft:"8px"}}></i></button>
            </a>
            <div className="ee">
            <a href = "https://suraj-bikerental-portal.netlify.app/" target="blank" className="anchor">
            <button className="codeBtn" >  Live Demo <i className="fas fa-level-up-alt" style={{marginLeft:"8px"}}></i></button></a>
            <div className="credentials">
            <div>
              <p  className="demoCred" style={{color:"#ccd602" , fontWeight:"bold"}}>DEMO CREDENTIALS</p>
              <p  className="demoCred" style={{color:"tomato"}}>UserName: </p>
    ...
    <div className="container" data-aos="zoom-in">
      <div className="row secondDiv">
        ...
        <div className="col-lg-6" style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <div style={{display:"flex" , marginTop:'15px' , flexWrap:"wrap" , position:"relative"}}>
            <a href="https://github.com/suraj860/E-Wallet-App" target="blank" className="anchor">
              <button className="codeBtn">Source Code <i className="fab fa-github" style={{marginLeft:"8px"}}></i></button>
            </a>
            <div className="ee">
      ...
      <div className="row secondDiv">
        ...
        <div className="col-lg-6"  style={{padding:" 0px 20px 20px 20px"}}>
          ...
          <div style={{display:"flex" , marginTop:'15px' , flexWrap:"wrap" , position:"relative"}}>
            ...
            <a href="https://github.com/suraj860/carwash_webApp" target="blank" className="anchor">
            <button className="codeBtn">Source Code <i className="fab fa-github" style={{marginLeft:"8px"}}></i></button>
            </a>
            <div className="ee">
